...
## Project Structure
    ...
    ├── testapiautoconnecto_54691  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_54691`
...
2. Clone this repo and `cd testapiautoconnecto_54691`
